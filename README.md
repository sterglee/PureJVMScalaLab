...
`This version of ScalaLab avoids to use native libraries, in order to be more portable, simpler and lighter. Besides, the performance of JVM code is adequate for most applications. `
