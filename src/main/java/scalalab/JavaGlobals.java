...
public class JavaGlobals {
   static public String jarFilePath;   
    ...
    static public String ApacheCommonsFile; // the Apache Commons Maths - current version, an embedded older version exists with the Java Algebra System, i.e. with the JASFile
