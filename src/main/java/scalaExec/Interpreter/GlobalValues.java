...
public class GlobalValues
{
    ...
    static public   String  scalalabBuildVersion = "23-Jan-18"; 
...
// for retrieving Matlab .mat file variables
   ...
   static public boolean mainToolbarVisible = false;
    ...
    static public String buildTitle() {
      String mainFrameTitle =        "ScalaLab (pure JVM):    Scala "+scala.tools.nsc.Properties.versionString()+",  library type: "+ GlobalValues.interpreterType()+ 
