...
public static void detectJarLibPaths(String watchStr) {
    ...
    public static void main(String[] args) {
       ...
       /* scalaExec.Interpreter.GlobalValues.scalalabLibPath = commonPrefix+File.separator+"lib";
System.out.println("lib= "+ scalaExec.Interpreter.GlobalValues.scalalabLibPath);
scalaExec.Interpreter.GlobalValues.scalalabHelpPath = commonPrefix+File.separator+"help";
System.out.println("help = "+ scalaExec.Interpreter.GlobalValues.scalalabHelpPath);
scalaExec.Interpreter.GlobalValues.jarFilePath = "ScalaLab.jar";
System.out.println("jarFile = "+scalaExec.Interpreter.GlobalValues.jarFilePath);
        scalaExec.Interpreter.GlobalValues.fullJarFilePath = commonPrefix+File.separator+"ScalaLab.jar"; 
System.out.println("full = "+ scalaExec.Interpreter.GlobalValues.fullJarFilePath);
*/
        ...
        try {
           ...
           if (vers.compareTo("1.5") < 0) {
            ...
            final scalaLab myGui = new scalaLab();
    ...
    //        scalaExec.Interpreter.GlobalValues.globalJavaEvaluator.reset();
            ...
            JOptionPane.showMessageDialog(null, "Stack overflow error, try to use:   java -jar -Xss20m -Xms200m -Xmx1000m -jar scalaLab.jar ");
            se.printStackTrace();
        } catch (OutOfMemoryError oe) {
            JOptionPane.showMessageDialog(null, "Out-of memory error, try to use:   java -jar -Xss20m -Xms200m -Xmx1000m -jar scalaLab.jar ");
            oe.printStackTrace();
        }
